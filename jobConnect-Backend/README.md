...
**JobConnect** is a comprehensive, full-stack recruitment platform connecting Candidates, Recruiters, and Administrators.
...
```
JobConnect/
├── jobConnect-Backend/     # Node.js + Express 5 + MongoDB Production REST API
└── jobConnect-Frontend/    # React 19 + Vite 8 + Redux Toolkit + SCSS Client
```
...
- [Frontend Documentation](./jobConnect-Frontend/README.md)
